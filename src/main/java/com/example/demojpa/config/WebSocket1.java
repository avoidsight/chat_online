...
public class WebSocket1 {
    ...
    private static final String loggerName= WebSocket1.class.getName();
     ...
     */
    @OnClose
    public void onClose(@PathParam("pageCode") String pageCode, Session session) throws IOException {
